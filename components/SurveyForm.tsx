 ...
 return (
  <div className="max-w-xl mx-auto bg-white rounded-lg shadow-lg p-6">
   <div className="text-center mb-8">
    <h1 className="text-3xl font-bold text-[#FC6F2F] mb-2">
     Survey Pelanggan 911 Coffee
    </h1>
   ...
   <form
    ...
    <div>
     <button
      ...
      className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#fc6f2f] hover:bg-[#fc6f2f]/80 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200">
      {isSubmitting ? (
       <>
        <svg
